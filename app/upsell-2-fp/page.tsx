                    ...
                    <div className="space-y-6 animate-in fade-in">
                        ...
                        <div className="bg-gradient-to-br from-rose-900/30 to-slate-900 border border-rose-500/30 rounded-2xl p-6 space-y-4 text-center">
                            ...
                            <div className="w-full flex flex-col items-center gap-3 pt-2">
                                <a href="javascript:void(0)" data-fortpay="nqozvq7tqg" className="fortpay_btn w-full py-4 bg-gradient-to-r from-[#3d94f6] to-[#1e62d0] text-white font-bold rounded-xl shadow-lg text-center">VIEW FULL REPORT</a>                                <a href="/downsell-2-fp" className="text-[#004faa] text-sm hover:underline">I don't want access</a>
                            </div>
                        </div>
                    </div>
                )}
