                ...
                <div className="bg-[#0f172a] rounded-xl shadow-2xl border border-slate-700/50 overflow-hidden relative">
                    ...
                    <div className="p-6 bg-[#0f172a] relative text-center">
                        ...
                        <div className="w-full flex flex-col items-center gap-3">
                            <button type="button" data-fortpay="emp8eejzsw" className="fortpay_btn w-full py-4 bg-gradient-to-r from-[#3d94f6] to-[#1e62d0] text-white font-bold rounded-xl shadow-lg transition-all text-center transform hover:scale-[1.02]">VIEW FULL REPORT</button>
